...
- [Mail Integration](/Pages/3Design/3.6.0MailClient.md): Searches all incoming mails for the keywords in the subject and extracts the images
...
- [Database](/Pages/3Design/3.5.0Database.md): Stores all output data from image processing
- [Frontend](/Pages/3Design/3.7.0Frontend.md): Contains all frontend functions
